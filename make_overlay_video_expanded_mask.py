"""
Same as make_overlay_video.py, except the segmentation mask gets grown out
by 5um (see MARGIN_UM in groups.py) before a point is tested for whether
it's "inside the embryo". Worth having both around since a few hundred
points near the boundary flip in or out depending on which test you use -
this is the more permissive of the two.
"""
import os
import numpy as np
