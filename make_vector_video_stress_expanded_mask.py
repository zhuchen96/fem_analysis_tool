"""
Expanded-mask twin of make_vector_video_stress.py.
"""
import os
import numpy as np
...
FRAME_DIR = f"{RESULT_DIR}/vector_arrows_pk1_stess_3_expanded_mask"
VIDEO_OUT = f"{RESULT_DIR}/vector_arrows_pk1_stess_3_expanded_mask.mp4"
FIELD = "pk1_stess_3"
EXPANDED = True
...
for i, t in enumerate(frames):
    ...
    fig.suptitle(f"pk1_stess_3 field, t={t} - average stress per region, one axis at a time (expanded mask)")
    fig.tight_layout()
